                            ...
                            @forelse ($penitips as $penitip)
                                <tr class="border-b hover:bg-gray-50 transition duration-150">
                                    ...
                                    <td class="p-3 text-sm text-gray-700">
                                        ...
                                        <form action="{{ route('cs.penitip.destroy', $penitip->id_penitip) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="text-red-600 hover:underline" onclick="return confirm('Are you sure you want to delete this penitip?')">Delete</button>
                                        </form>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="7" class="p-3 text-center text-gray-500">No penitips found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
